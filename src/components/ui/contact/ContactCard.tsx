...
const ContactCard = () => {
  return (
    <motion.article
      className="text-center border bg-[var(--card-background)] border-neutral-800 w-full rounded-xl flex flex-col md:flex-row gap-10 md:gap-15 shadow-sm shadow-black p-6 md:p-12 z-10"
