...
const SectionTitle = ({ title, subtitle, className = "" }: SectionTitleProps) => {
  return (
    <div
      ...
      <div>
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-relaxed mb-4 md:mb-6 lg:mb-8 text-[var(--text)]">
          {title}
        </h2>
        {subtitle && (
          <p className="text-[15px] sm:text-base md:text-lg text-[var(--secondary-text)] max-w-2xl">
            {subtitle}
          </p>
        )}
      </div>
